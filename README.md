...
[Iron](https://github.com/hueniverse/iron) supports password rotation, which
enables you to archive an even higher level of security, by changing your secret
which encrypts your cookies.

To setup password rotation you need to pass a combined object to iron. The
current password is expected as `{ id, secret }` and historical passwords
are expacted as an array of objects or strings `['secret1', 'secret2']`.

A complete example of a working configuration with password rotation enabled
...
module.exports = {
  cookies: {
    ...
    password: {
      id: "1",
      secret: "3ojb4bcujgq2upsekwuj6sojyk1qdtng",
      ...[
        "qum0fl55aqhvq1edl1sww8jr5642x4n1",
        "3ojb4bcujgq2upsekwuj6sojyk1qdtng"
      ]
    },
    isSecure: true,
    isHttpOnly: true,
